...
def update_mission_xml(mission_xml):
	...
	master_dir += '/find_treasure_QLearning'
...
def get_observations(agent_host):
	"""	从代理最近的world state获取world observations
		args:	malmo agent host	(created beforehand in an outer scope)
